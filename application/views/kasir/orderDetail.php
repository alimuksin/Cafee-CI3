				...
				<div class="card">
					<div class="card-body">
						<div class="text-center p-3">
							Status Pembayaran :
							<?= transaksi($this->global->kasir_transaksi($checkout->id_checkout)->status_transaksi) ?>
						</div>
						<form method="POST" action="<?= base_url('kasir/updateorder/'.$checkout->id_checkout) ?>">
							<div class="form-group">
								<label for="">Rubah Status Pembayaran</label>
			...
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<a class="btn btn-primary mt-3" href="#" onclick="openWin()" >
...
<script type="text/javascript">
  	function openWin()
	{
		var myWindow=window.open('<?=base_url('kasir/print/'.$checkout->id_checkout) ?>','','width=500,height=700');
